...
public class DecayingLinzerTartBlock extends DecayingPieBlock{
    private static final Supplier<VoxelShape> fullShapeSupplier = () -> Shapes.box(0.0625F, 0.0F, 0.0625F, 0.9375F, 0.1875F, 0.9375F);
    ...
    private static final Supplier<VoxelShape> threeShapeSupplier = () -> {
        ...
        shape = Shapes.or(shape, Shapes.box(0.0625F, 0.0F, 0.5F, 0.9375F, 0.1875F, 0.9375F));
        shape = Shapes.or(shape, Shapes.box(0.0625F, 0.0F, 0.0625F, 0.5F, 0.1875F, 0.5F));
        return shape;
    };
    ...
    private static final Supplier<VoxelShape> halfShapeSupplier = () -> Shapes.box(0.0625F, 0.0F, 0.5F, 0.9375F, 0.1875F, 0.9375F);
    ...
    private static final Supplier<VoxelShape> quarterShapeSupplier = () -> Shapes.box(0.0625F, 0.0F, 0.5F, 0.5F, 0.1875F, 0.9375F);
