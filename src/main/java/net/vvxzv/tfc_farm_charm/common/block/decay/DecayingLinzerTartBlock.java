...
public class DecayingLinzerTartBlock extends DecayingPieBlock{
    private static final Supplier<VoxelShape> fullShapeSupplier = () -> Shapes.box((double)0.0625F, (double)0.0F, (double)0.0625F, (double)0.9375F, (double)0.1875F, (double)0.9375F);
    ...
    private static final Supplier<VoxelShape> threeShapeSupplier = () -> {
        ...
        shape = Shapes.or(shape, Shapes.box((double)0.0625F, (double)0.0F, (double)0.5F, (double)0.9375F, (double)0.1875F, (double)0.9375F));
        shape = Shapes.or(shape, Shapes.box((double)0.0625F, (double)0.0F, (double)0.0625F, (double)0.5F, (double)0.1875F, (double)0.5F));
        return shape;
    };
    ...
    private static final Supplier<VoxelShape> halfShapeSupplier = () -> Shapes.box((double)0.0625F, (double)0.0F, (double)0.5F, (double)0.9375F, (double)0.1875F, (double)0.9375F);
    ...
    private static final Supplier<VoxelShape> quarterShapeSupplier = () -> Shapes.box((double)0.0625F, (double)0.0F, (double)0.5F, (double)0.5F, (double)0.1875F, (double)0.9375F);
    ...
    public DecayingLinzerTartBlock(ExtendedProperties properties, Supplier<Item> slice, Supplier<? extends Block> rotted) {
