...
public class Fluids {
    ...
    public static final Map<Beers, FluidRegistryObject<ForgeFlowingFluid>> BEERS = Helpers.mapOfKeys(
            Beers.class,
            (fluid) -> register(
                    fluid.getSerializedName(),
                    (properties) -> properties.block(Blocks.BEER_FLUIDS.get(fluid)).bucket(Items.BEER_FLUID_BUCKETS.get(fluid)),
